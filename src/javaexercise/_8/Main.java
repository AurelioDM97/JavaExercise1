...
public class Main {
    ...
    private static void exercise1() {
        ...
        int ourInteger = Integer.valueOf((ourNumberStr));
        System.out.println(ourInteger);

        int ourInteger2 = ourInteger +2;
        System.out.println(ourInteger2);

        String ourString = String.valueOf((ourInteger2));
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "5.8"; // Also this line
    ...
    private static void exercise4() {
        ...
        String startStr = "5";
        int stringToInteger = Integer.valueOf(startStr);
        System.out.println(stringToInteger);

        stringToInteger*=2;
        System.out.println(stringToInteger);

        String integerToString = String.valueOf(stringToInteger).toString();
        String twoIntegerToStringConcatenate = integerToString + integerToString;
        System.out.println(twoIntegerToStringConcatenate);

        double stringToDouble = Double.valueOf(twoIntegerToStringConcatenate);
        System.out.println(Math.floor(stringToDouble/3.5));
