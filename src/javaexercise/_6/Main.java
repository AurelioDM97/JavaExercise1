...
public class Main {
    ...
    private static void exercise2() {
        ...
        System.out.println("Il numero maggiore è: " +Math.max(valueA, valueB));
        System.out.println("Il numero minore è: " +Math.min(valueA, valueB));
    ...
    private static void exercise3() {
        ...
        int totalMoney = 50;
        int costPerBurger = 9;
        int remainingMoneyAfterBuyingAllBurgers = totalMoney %costPerBurger;

        System.out.println("L'ammontare di soldi rimasto dopo aver comprato più hamburger possibili è: "
                +remainingMoneyAfterBuyingAllBurgers);
