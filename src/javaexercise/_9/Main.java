...
public class Main {
    ...
    private static void exercise2() {
        ...
        if (remainingMoney >= lunchCost) {
            ...
            System.out.println("I'm sorry, you go hungry today!");
        }
    }
    ...
    private static void exercise3() {
        ...
        double increasedDouble = ourDouble + 1;

        if (ourDouble > 2.5) {
            System.out.println(ourDouble + " is greater than 2.5");
        } else if (increasedDouble < 2.5) {
            System.out.println(increasedDouble + " is still less than 2.5");
        } else{
            System.out.println(increasedDouble + " is now greater than 2.5");
        }
