...
public class Main {
    ...
    public static double exercise1(String text, double expectedScore) {
        ...
        double maxScore = 20;
        boolean isAllLowerCase = text.equals(text.toLowerCase());
        boolean textContainsA = text.contains("a");
        yourScore = Math.min(yourScore, maxScore);
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        if (yourMealScore < minScore) {
            yourMealScore = minScore;
        }
